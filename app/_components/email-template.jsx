    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={message}>
          <Img
            src={`https://res.cloudinary.com/dmmbxksq2/image/upload/v1709867775/mushroom_c2c04a5dc3.png`}
            width="100"
            height="100"
            alt="logo"
            style={{ margin: "auto" }}
        ...
        <Section style={global.defaultPadding}>
          <Text style={adressTitle}>Shipping to: {body.fullName}</Text>
        </Section>
        <Hr style={global.hr} />
        <Section
        ...
        >
          {body?.cart?.map((item)=>(
            ...
            <Column>
              <Img
                src={item?.attributes?.games?.data[0]?.attributes?.banner?.data?.attributes?.url}
                alt={item?.attributes?.games?.data[0]?.attributes?.title}
                style={{ float: "left" }}
                width="260px"
              />
            </Column>
            <Column style={{ verticalAlign: "top", paddingLeft: "12px" }}>
              <Text style={{ ...paragraph, fontWeight: "500" }}>
							{item?.attributes?.games?.data[0]?.attributes?.title}
              </Text>
            </Column>
          </Row>
					))}
        ...
        <Section style={global.defaultPadding}>
          <Row style={{ display: "inline-flex", marginBottom: 40 }}>
            ...
            <Column>
              ...
              <Text style={track.number}>{body.date}</Text>
            </Column>
          </Row>
          <Row>
            <Column align="center">
        ...
        <Section style={paddingY}>
          <Row>
            <Text style={global.heading}>gamers-launge.vercel.app</Text>
          </Row>
        </Section>
        ...
        <Section style={paddingY}>
          ...
          <Row>
            <Text style={footer.text}>
              © 2022 GamerLaunge, Inc. All Rights Reserved.
            </Text>
          </Row>
          <Row>
            <Text style={footer.text}>
